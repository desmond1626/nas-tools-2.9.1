...
class TMDb(object):
    ...
    def cached_request(method, url, data, proxies):
        return requests.request(method, url, data=data, proxies=eval(proxies), verify=False, timeout=50)
    ...
    def _call(
        ...
        if self.cache and self.obj_cached and call_cached and method != "POST":
            ...
            req = self._session.request(method, url, data=data, proxies=eval(self.proxies), timeout=50, verify=False)
